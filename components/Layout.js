        ...
        <AppBar position="static" sx={layoutStyles.appbar}>
          <Toolbar sx={layoutStyles.toolbar}>
            <Box display="flex" alignItems="center">
              ...
              >
                <MenuIcon sx={layoutStyles.navbarButton} />
              </IconButton>
            ...
            <Box sx={isDesktop ? layoutStyles.visible : layoutStyles.hidden}>
              <form onSubmit={submitHandler}>
                <Box sx={layoutStyles.searchForm}>
                  <InputBase
                    name="query"
                    sx={layoutStyles.searchInput}
                    placeholder="Search products"
                    onChange={queryChangeHandler}
                  />
                  <IconButton
                    type="submit"
                    sx={layoutStyles.searchButton}
                    aria-label="search"
                  >
                    <SearchIcon />
                  </IconButton>
