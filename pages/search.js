...
export default function SearchScreen() {
  ...
  return (
    <Layout title="search">
      <Grid sx={layoutStyles.section} container spacing={2}>
        <Grid item md={3}>
          <List>
            <ListItem>
              <Box sx={layoutStyles.fullWidth}>
        ...
        <Grid item md={9}>
          <Grid container justifyContent="space-between" alignItems="center">
            ...
            <Grid item>
              <Typography component="span" sx={layoutStyles.sort}>
                Sort by
              </Typography>
          ...
          <Grid sx={layoutStyles.section} container spacing={3}>
            {loading ? (
              <CircularProgress />
            ) : error ? (
              <Alert>{error}</Alert>
